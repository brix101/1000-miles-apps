...
import { Retake, useGetInfiniteRetakes } from '..';

interface RetakeContainerProps {
  dataQuery: ReturnType<typeof useGetInfiniteRetakes>;
}

export function RetakeContainer({ dataQuery }: RetakeContainerProps) {
